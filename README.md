...
There is a utility subcommand named `version` which can be used to get the OED schema version (currently `1.1.1`) the package uses, or the package version (currently `0.8.0`). Usage is
